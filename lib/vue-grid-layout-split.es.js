...
const _sfc_main = {
  ...
  methods: {
    ...
    addCard(obj, toTop = true) {
      ...
      let dist = { ...obj, w: 1, x: 2, y, id, type, height };
      if (type === GridItemType.BIG)
        dist.x = 0;
...
const _withScopeId = (n) => (pushScopeId("data-v-82449fba"), n = n(), popScopeId(), n);
...
function _sfc_render(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  const _component_grid_layout = resolveComponent("grid-layout");
  return openBlock(), createBlock(_component_grid_layout, {
    ref: "gridLayout",
    layout: $data.layout,
    ...
    default: withCtx(() => [
      (openBlock(true), createElementBlock(Fragment, null, renderList($data.layout, (item) => {
        return openBlock(), createBlock(_component_grid_item, {
          key: item.i,
          x: item.x,
          y: item.y,
          w: item.w,
          ...
          class: normalizeClass(`sk-grid-item-${item.i}`),
          onMove: $options.startMoveEvent,
          onMoved: $options.movedEvent
        }, {
          default: withCtx(() => [
            renderSlot(_ctx.$slots, "default", { value: item }, () => [
              createElementVNode("div", _hoisted_1, toDisplayString(item.i), 1)
            ], true),
            $props.editMode ? (openBlock(), createElementBlock(Fragment, { key: 0 }, [
              $props.editMode && $props.editMask ? (openBlock(), createElementBlock("div", {
                key: 0,
                class: "edit-mask",
              ...
              createElementVNode("div", {
                ...
                renderSlot(_ctx.$slots, "delete-tip", { value: item }, () => [
                  _hoisted_3
                ], true)
              ], 8, _hoisted_2)
...
var _VueGridLayoutSplit = /* @__PURE__ */ _export_sfc(_sfc_main, [["render", _sfc_render], ["__scopeId", "data-v-82449fba"]]);
...
export { GridItemType, GridPosition, vueGridLayoutSplit as default };
