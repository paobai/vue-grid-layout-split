...
var vueGridLayoutInstall = require("vue-grid-layout");
var vue = require("vue");
function _interopDefaultLegacy(e) {
  return e && typeof e === "object" && "default" in e ? e : { "default": e };
}
var vueGridLayoutInstall__default = /* @__PURE__ */ _interopDefaultLegacy(vueGridLayoutInstall);
...
const _sfc_main = {
  ...
  components: {
    GridLayout: vueGridLayoutInstall.GridLayout,
    GridItem: vueGridLayoutInstall.GridItem
  },
  props: {
    defaultLayout: {
      type: Array,
...
const _withScopeId = (n) => (vue.pushScopeId("data-v-82449fba"), n = n(), vue.popScopeId(), n);
...
const vueGridLayoutSplit = Object.assign(_VueGridLayoutSplit, {
  install: (app) => {
    ...
    app.use(vueGridLayoutInstall__default["default"]);
