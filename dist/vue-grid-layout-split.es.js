...
import { resolveComponent, openBlock, createElementBlock, createVNode, withCtx, Fragment, renderList, createBlock, normalizeClass, renderSlot, createElementVNode, toDisplayString, withModifiers, createCommentVNode } from "vue";
...
function _sfc_render(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  return openBlock(), createElementBlock("div", _hoisted_1, [
    createVNode(_component_grid_layout, {
      ref: "gridLayout",
      layout: $data.layout,
          ...
          return openBlock(), createBlock(_component_grid_item, {
            ...
            default: withCtx(() => [
              renderSlot(_ctx.$slots, "default", { value: item }, () => [
                createElementVNode("div", _hoisted_2, toDisplayString(item.i), 1)
              ], true),
              $props.editMode ? (openBlock(), createElementBlock(Fragment, { key: 0 }, [
                $props.editMode ? (openBlock(), createElementBlock("div", {
                  key: 0,
                  class: "edit-mask",
